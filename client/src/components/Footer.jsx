          ...
          <div className="col-span-1">
            <div className="flex items-center mb-4">
              <img
                ...
                alt="Bindal Papers"
              />
              <span className="ml-2 text-xl font-bold">Bindal Papers</span>
            </div>
            <p className="text-gray-300 text-sm leading-6">
              Leading manufacturer of high-quality paper products and sugar industry solutions. 
              Committed to excellence and sustainability in every product we deliver.
            </p>
            <div className="mt-6">
          ...
          <div className="col-span-1">
            ...
            <div className="space-y-3 text-sm text-gray-300">
              ...
              <div>
                ...
                <p>info@bindalpapers.com</p>
              </div>
              <div>
                <p className="font-medium text-white">Factory</p>
        ...
        <div className="mt-8 pt-8 border-t border-gray-700">
          <div className="flex flex-col md:flex-row justify-between items-center">
            <p className="text-gray-400 text-sm">
              © {new Date().getFullYear()} Bindal Papers. All rights reserved.
            </p>
            <div className="mt-4 md:mt-0">
              <p className="text-gray-400 text-xs">
                Design assets are placeholders for demonstration purposes only.
              </p>
            </div>
          </div>
        </div>
